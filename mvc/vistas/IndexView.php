...
<head>
    ...
    <?php
        ...
        require_once '../../assets/php/logica_index.php';
    ?>
    <header>
        <div class="selectors">
            <div class="dropdown" title="Select language">
                ...
                <ul>
                    <li><a href="IndexView.php?lang=en"><?php echo $lang['lang_en'] ?></a></li>
                    <li><a href="IndexView.php?lang=es"><?php echo $lang['lang_es'] ?></a></li>
                </ul>
            </div>
