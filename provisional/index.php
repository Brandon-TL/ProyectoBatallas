    ...
    <div class="container" id="container">
        ...
        <div class="form-container sign-in-container">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <?php if (isset($_logueo_usuario_err)) echo $_logueo_usuario_err; ?>

                <input type="password" name="password" placeholder="<?php echo $lang['logueo_label_password'] ?>">
                <?php if (isset($_logueo_password_err)) echo $_logueo_password_err; ?>
        ...
        <div class="form-container sign-up-container">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <?php if (isset($_registro_usuario_err)) echo $_registro_usuario_err; ?>
                ...
                <?php if (isset($_registro_password_err)) echo $_registro_password_err; ?>
                ...
                <?php if (isset($_registro_password2_err)) echo $_registro_password2_err; ?>
                
                <input type="email" name="email" value="<?php if (isset($_email)) echo $_email; ?>" placeholder="<?php echo $lang['registro_label_email']; ?>">
                <?php if (isset($_registro_email_err)) echo $_registro_email_err; ?>
